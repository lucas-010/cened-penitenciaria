...
export default function SubBottom() {
  return (
    <div className='w-full h-96' style={{background: `url(${ponteJk}), rgba(0, 0, 0, 0.7)`,backgroundSize: 'cover', backgroundPosition: 'center',backgroundRepeat: 'no-repeat', backgroundBlendMode: 'darken'}}>
