...
export default function LoginAccess() {
  return (
    <div className='bg-[#012060] flex items-center justify-center h-2/3 w-screen p-8'>
        <form className='flex lg:flex-row md:flex-row flex-col'>
            ...
            <button className='text-2xl mt-5 md:ml-10 lg:ml-10 text-white p-2 border-4 px-4 rounded-lg hover:bg-green-500 transition-colors font-bold border-green-500'>Acessar</button>
        </form>
    </div>
  )
}
